...
select * from customer_behavior limit 2;
...
select shipping_type, round(avg(purchase_amount),2) as avg_purchased_amount
from customer_behavior 
...
select category,count(customer_id) from customer_behavior group by category,item_purchased;
